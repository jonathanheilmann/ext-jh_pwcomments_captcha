# -*- coding: utf-8 -*-
#
# pwComments captcha documentation build configuration file, created by
# TYPO3 extension sphinx on Sat, 22 Aug 2015 21:50:35 +0200.
#
...
project = u'pwComments captcha'
copyright = u'2015, Jonathan Heilmann'
...
htmlhelp_basename = 'jh_pwcomments_captchadoc'
...
latex_documents = [
    ('Index', 'jh_pwcomments_captcha.tex', u'pwComments captcha',
     u'Jonathan Heilmann', 'manual'),
]
...
pdf_documents = [
    ('Index', 'jh_pwcomments_captcha', u'pwComments captcha',
     u'Jonathan Heilmann'),
]
...
texinfo_documents = [
    ('Index', 'jh_pwcomments_captcha', u'pwComments captcha',
     u'Jonathan Heilmann', 'pwComments captcha', 'One line description of project.',
     'Miscellaneous'),
]
